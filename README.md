...
### 2. Run
```ruby
  > dotnet new --install ASPNETTariffComparison.nuspec::3.0.5
  ```
### 3. Create an empty folder for your solution and cd into it.
### 4. Run the following code and enter your project name instead of MyNewTariffComparison

```ruby
  > dotnet new ASPNETTariffComparison -n MyNewTariffComparison
  ```
