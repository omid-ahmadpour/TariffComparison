...
namespace TariffComparison.Persistance.Repositories
{
    public class EfReadOnlyRepository<TEntity> : IReanOnlyRepository<TEntity>
        where TEntity : class, IEntity
    {
        protected readonly AppReadOnlyDbContext DbContext;
        ...
        public EfReadOnlyRepository(AppReadOnlyDbContext dbContext)
        {
            DbContext = dbContext;
